...
Route::get('index','index/index/index');  //一般路由规则，

Route::resource(':version/user','api/:version.user');       //资源路由

Route::post(':version/token','api/:version.token/token');  //生成access_token
Route::post(':version/getTestToken','api/:version.token/getTestToken');  //一般路由规则，


Route::post(':version/refresh','api/:version.token/refresh');  //刷新access_token
